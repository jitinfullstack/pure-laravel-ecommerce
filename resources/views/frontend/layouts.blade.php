...
<html lang="en">
  <head>
    ...
    <!-- <link id="switcher" href="{{ asset('frontend_assets/css/theme-color/bridge-theme.css') }}" rel="stylesheet"> -->
    <!-- Top Slider CSS -->
                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="{{ asset('frontend_assets/img/flag/english.jpg') }}" alt="english flag">ENGLISH
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                      <li><a href="#"><img src="{{ asset('frontend_assets/img/flag/french.jpg') }}" alt="">FRENCH</a></li>
                      <li><a href="#"><img src="{{ asset('frontend_assets/img/flag/english.jpg') }}" alt="">ENGLISH</a></li>
                    </ul>
                  </div>
                </div>
                <!-- / language -->
          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <!-- img based logo -->
                <!-- <a href="javascript:void(0)"><img src="{{ asset('frontend_assets/img/logo.jpg') }}" alt="logo img"></a> -->
              </div>
              <!-- / logo  -->
               <!-- cart box -->
               @php
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="{{ route('cart') }}" id="cartBox">
              ...
              <div class="aa-search-box">
                <form action="">
                  <input type="text" name="" id="search_term" placeholder="Search here ex. 'man' ">
                  <button type="button" onclick="searchFunction()"><span class="fa fa-search"></span></button>
                </form>
              </div>
              <!-- / search box -->
            </div>
      ...
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <form class="aa-login-form" id="frmLogin">
                ...
                <input type="password" name="str_login_password" placeholder="Password" required value="{{ $login_password }}">
            ...
            <div id="popup_forgot" style="display: none;">
                ...
                <div>&nbsp;</div><br><br>
                <div id="forgot_msg" class="field_error" style="float: left">&nbsp;</div>

                <div class="aa-register-now">
                    Already have an account?<a href="javascript:void(0)" onclick="show_login_popup()">Login now!</a>
                </div>
                @csrf
                </form>
            </div>
